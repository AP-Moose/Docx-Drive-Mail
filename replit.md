...
- The user does NOT pick project type, price, or timeline from dropdowns
- AI reads scope notes and infers: project type (stored in `projectType` column), pricing, timeline, materials
- `projectType` starts as "General" and gets updated after AI generation
